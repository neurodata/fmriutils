...
fmriu.plot.plot_dataseries(ts, title="Timeseries Plot", xlabel = "time", ylabel="intensity", legend = "ROI")
```
...
```{r}
fs <- freq[[1]]
fmriu.plot.plot_dataseries(fs, xax=fmriu.freq.freq_seq(fs=1/2.5, nt=dim(fs)[2]),
                           title="Power Plot", xlabel = "frequency", ylabel="power", legend = "ROI")
```
